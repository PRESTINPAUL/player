<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="146" height="173"
  viewBox="0 0 146 173" class="svg-slider-arrow" id="svgObject-1">
  <defs>
    <style>
    ...
    <rect id="icon_arrow_gallery_loader_web-e" class="prev icon_arrow_loader_slick" width="70" height="70"
      x="5" y="5" rx="35" />
  ...
  <g fill="none" fill-rule="evenodd" transform="rotate(-90 81.5 61.5)">
    ...
    <g transform="rotate(-83 40 40)">
      <use fill="#000" filter="url(#icon_arrow_gallery_loader_web-d)" xlink:href="#icon_arrow_gallery_loader_web-e"
        class="hover-fill-item prev icon_arrow_loader_slick" />
      <rect class="filler-prev" width="68.5" height="68.5" x="5.75" y="5.75" stroke="#FFF" stroke-width="1.5"
        rx="34.25" />
    </g>
  </g>
</svg>