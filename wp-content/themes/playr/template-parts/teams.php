<div class="Teams">
  <div class="u-container">
    ...
    <p class="Teams-title Teams-stats">
    ...
    <?php if( have_rows('club_carousel_repeater', pll_current_language('slug')) ): ?>
      <?php $counter = 1 ?>
      <ul class="Teams-list" id="js-team-carousel" data-aos="fade-in" data-aos-delay="350">
        <?php while( have_rows('club_carousel_repeater', pll_current_language('slug')) ): the_row(); 
          // vars
