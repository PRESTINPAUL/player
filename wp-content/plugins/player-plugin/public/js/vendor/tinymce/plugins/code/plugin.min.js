!function () {
  ...
  var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    return t.getContent({ source_view: !0 });
      ...
      e = function (n) {
    var t = o(n),
        e = i(n);n.windowManager.open({ title: "Source code", body: { type: "textbox", name: "code", multiline: !0, minWidth: t, minHeight: e, spellcheck: !1, style: "direction: ltr; text-align: left" }, onSubmit: function (t) {
        c(n, t.data.code);
      } }).find("#code").value(d(n));
  },
      u = function (t) {
    t.addCommand("mceCodeEditor", function () {
      ...
      a = function (t) {
    t.addButton("code", { icon: "code", tooltip: "Source code", onclick: function () {
        e(t);
      } }), t.addMenuItem("code", { icon: "code", text: "Source code", onclick: function () {
        e(t);
      } });
