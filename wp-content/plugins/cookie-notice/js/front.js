( function ( $ ) {
	...
	$( document ).ready( function () {
			...
			if ( cnArgs.refuse === 'yes' ) {
				...
				if ( cnArgs.revoke_cookies === '1' ) {
					...
					if ( revoke.hasClass( 'cn-revoke-inline' ) ) {
						...
						if ( ! ( body.hasClass( 'cookies-revoke' ) || body.hasClass( 'cookies-not-accepted' ) ) ) {
		...
		if ( typeof cookie === 'undefined' ) {
			...
			$.fn.setCookieNoticeBodyClass( 'cookies-not-accepted' );
	...
	$.fn.setCookieNoticeBodyClass = function( classes ) {
		$( 'body' ).removeClass( 'cookies-revoke cookies-accepted cookies-refused cookies-set cookies-not-accepted' ).addClass( classes );
	}
