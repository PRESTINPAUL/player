...
define('DATABASE_SERVER', 'catapult-prod-eu.cyxvd3fbg9eq.eu-central-1.rds.amazonaws.com');
define('DATABASE_NAME', 'shopifyprod');
define('DATABASE_USER', 'shopifyprod');
define('DATABASE_PASSWORD', 'n1MMMrSPIgWdw');
...
define('SMTP_RECEIVER', 'vivin@qburst.com');
...
$store = ['STORE_UK' => [
   ...
   'STORE_Staff' => [
        'store_name' => 'playrsmartcoach-staff',
        'url' => 'playrsmartcoach-staff.myshopify.com',
        'order_prefix' => 'PR66',
        'api_key' => 'caad6bbdf57e93c911ebe87216d56540',
        'secret_key' => 'f247651c9c5dc9858d91f5167d95f598',
        'location_id' => '6513950832',
    ],
